      ...
      <React.Fragment>
        <div>
          {supportedLangs.map(lang => 
            ...
            >
              {lang.toUpperCase() !== 'HBS' ? lang.toUpperCase() : hbsLogo}
            </Button>
          )}
          <Button
            onClick={this.onCopy}
