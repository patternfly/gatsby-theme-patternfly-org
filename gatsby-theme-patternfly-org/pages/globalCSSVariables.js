  ...
  return (
    <SideNavLayout location={location} context={context}>
      <PageSection className="ws-section" variant={PageSectionVariants.light}>
        ...
        <p className="ws-p">The CSS variable system is a two-layer theming system where global variables inform component variables.</p>
        <AutoLinkHeader size="h2">Global variables</AutoLinkHeader>
        <p className="ws-p">Global variables define and enforce global style elements (like values for color, spacing, and font size) across the entire system.</p>
        <p className="ws-p">Global variables follow this formula:</p><code className="ws-code">--pf-global--concept--PropertyCamelCase--modifier--state</code>
        <p className="ws-p">Where...</p>
        <ul>
        ...
        <p className="ws-p">Component variables are used to define custom properties at the component-level. Component variables are always defined by global variables.</p>
        <p className="ws-p">Component variables follow this formula:</p><code>--pf-c-block__element--modifier--state--breakpoint--pseudo-element--PropertyCamelCase</code>
        <p className="ws-p">Where...</p>
        <ul>
